...
export abstract class IQuery {
  ...
  abstract getLootboxOptions(
    creatorId: number,
    lootboxId: number,
  ): Nullable<Nullable<LootboxOption>[]> | Promise<Nullable<Nullable<LootboxOption>[]>>;

  abstract getAllRecipes(): Nullable<Nullable<Recipe>[]> | Promise<Nullable<Nullable<Recipe>[]>>;

  abstract getRecipes(
    creatorId: number,
  ): Nullable<Nullable<Recipe>[]> | Promise<Nullable<Nullable<Recipe>[]>>;

  abstract getRecipe(
    creatorId: number,
    recipeId: number,
  ): Nullable<Recipe> | Promise<Nullable<Recipe>>;

  abstract getSeasonXpRanking(
    creatorId: number,
    seasonId: number,
  ): Nullable<Nullable<SeasonRanking>[]> | Promise<Nullable<Nullable<SeasonRanking>[]>>;

  abstract getAllXpRanking(
    creatorId: number,
  ): Nullable<Nullable<AllSeasonRanking>[]> | Promise<Nullable<Nullable<AllSeasonRanking>[]>>;

  abstract getReputationRanking(
    creatorId: number,
  ): Nullable<ReputationRanking> | Promise<Nullable<ReputationRanking>>;

  abstract getReputationRankings(
    creatorId: number,
  ): Nullable<Nullable<ReputationRanking>[]> | Promise<Nullable<Nullable<ReputationRanking>[]>>;
...
export abstract class IMutation {
  abstract claimReward(
    ...
    premium: boolean,
    autoRedeem: boolean,
  ): ClaimRewardResponse | Promise<ClaimRewardResponse>;
